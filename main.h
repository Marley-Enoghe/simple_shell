...
void set_env(char *namme, char *valuue, data_shell *dattash);
...
/* get_builtin */
int (*get_builtin(char *cmdd))(data_shell *dattash);
...
char *error_get_cd(data_shell *dattash);
char *error_not_found(data_shell *dattash);
char *error_exit_shell(data_shell *dattash);

/* aux_error2.c */
char *error_get_alias(char **argss);
char *error_env(data_shell *dattash);
char *error_syntax(char **argss);
char *error_permission(char **argss);
char *error_path_126(data_shell *dattash);
