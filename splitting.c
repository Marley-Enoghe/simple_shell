 ...
 * Return: no return
 */
void go_next(sep_list **list_s, line_list **list_l, data_shell *dattash)
{
	int loop_sep;
	sep_list *ls_s;
	line_list *ls_l;
...
/**
 * split_commands - splits commandlines to
 ...
 */
int split_commands(data_shell *dattash, char *inputt)
{
